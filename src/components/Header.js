...
const brandCategories = [
  ...
  {
    name: 'Advanced Vibration Plates',
              ...
              >
                <div className="py-1">
                  {brandCategories.map((category) => (
                    ...
                    >
                      <div
                        className="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-violet-50 hover:text-violet-600 cursor-pointer"
                      >
              ...
              <div className="space-y-1">
                ...
                {mobileExpandedReviews && (
                  <div className="pl-4">
                    ...
                    >
                      {locale === 'de' ? 'Alle Vibration Plates' : 'All Vibration Plates'}
                    </Link>
                    {reviewCategories.map((category) => (
                      <Link
                        key={category.slug}
