  ...
  return (
    <section className="bg-white py-16 px-4 md:px-8">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        {data.title && (
          <h2 className="text-3xl font-extrabold text-[#9402c0] mb-6 text-center">
            {data.title}
          </h2>
        )}
        ...
        {/* Box 1 */}
        {data.box1 && (
          <div className="w-full bg-[#16173b] rounded-xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.15)] mb-8">
